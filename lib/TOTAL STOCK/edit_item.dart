...
class edit_item_screen extends StatefulWidget {
  const edit_item_screen({super.key});

  @override
  State<edit_item_screen> createState() => _edit_item_screenState();
}
...
class _edit_item_screenState extends State<edit_item_screen> {
  ...
  void updateitem(docid) {
    final data = {
      'name': itemname.text,
      'number': itemnumber.text,
      'img': image
    };
    _reference.doc(docid).update(data);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          backgroundColor: Color.fromARGB(255, 177, 26, 6),
        ),
        body: SafeArea(
            child: Container(
                ...
                decoration: BoxDecoration(
                    image: const DecorationImage(
                        image: AssetImage('assets/IMAGE/EW copy.jpg'),
